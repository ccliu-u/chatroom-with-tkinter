...
class MainPanel:
    ...
    def show_main_panel(self):
        ...
        self.p1 = PhotoImage(file='表情包/微信表情1.png')
        self.p2 = PhotoImage(file='表情包/微信表情2.png')
        self.p3 = PhotoImage(file='表情包/微信表情3.png')
        self.p4 = PhotoImage(file='表情包/微信表情4.png')
        self.p5 = PhotoImage(file='表情包/微信表情5.png')
        self.p6 = PhotoImage(file='表情包/微信表情6.png')
        self.p7 = PhotoImage(file='表情包/微信表情7.png')
        self.p8 = PhotoImage(file='表情包/微信表情8.png')
        self.p9 = PhotoImage(file='表情包/微信表情9.png')
        self.p10 = PhotoImage(file='表情包/微信表情10.png')

        # 按钮图片，把图片转换为PhotoImage
        self.p11 = PhotoImage(file='button/表情按钮.png')
        self.p12 = PhotoImage(file='button/聊天记录按钮.png')
        ...
        button1 = Button(self.main_frame, command=lambda: self.send_message(self), text="发送", bg="#00BFFF",
                         fg="white", width=11, height=2, font=('黑体', 12),)
    ...
    def create_window(self):
        ...
        # 设置文本标签
        title_lable = Label(top1, text="聊天记录", font=('黑体', 18, 'bold italic'),
                            fg="white", bg="#00BFFF")
        # 设置文本在窗口的位置
