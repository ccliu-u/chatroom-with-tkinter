...
class LoginPanel:
    ...
    def show_login_panel(self):
        ...
        # 创建标签并设置图像
        img_label = Label(self.login_frame, image=tk_image, height=400, width=500)
        img_label.place(x=-252, y=-200, relx=0.5, rely=0.5, relwidth=1, relheight=0.5)
        # img_label.configure(image=tk_image)


        # 设置文本标签和位置
        Label(login_frame, text="昵称：", font=("等线", 11), bg="white", fg="grey") \
            .place(x=124, y=230)
        Label(login_frame, text="密码：", font=("等线", 11), bg="white", fg="grey") \
            .place(x=124, y=260)
